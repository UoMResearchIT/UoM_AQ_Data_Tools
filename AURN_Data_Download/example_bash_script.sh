...
ARGUMENTS_1="--no_impute_values --metadata_url ${META_DATA_URL} --min_years ${MINYEARS} --useful_num_years ${USEYEARS} --metadata_filename ${META_DATA_FILENAME} --years ${YEARS} --sites ${SITES} -o ${OUT_DIR} -s ${OUTFILE_SUFFIX}  --verbose ${VERBOSE}"
